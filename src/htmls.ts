...
export const G2GCancelHTML = (orderID: string) => {
  return `
...
export const G2GConfirmationHTML = (orderID: string) => {
  return `
  Thank you.
  <br />
  <br />
...
export const PAOrderHTML = (product: string) => {
  return `
...
export const P2PAHOrderHTML = (product: string, price: string) => {
  return `
  <p><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Dear </span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">,</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">You have a new sell order. Please prepare the items for delivery as soon as possible or click "Chat Now" in your order details page to contact the buyer for delivery arrangement.</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Order Summary:</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">--------------------------------------------------------------</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Sell Order Number: 2022011798101102</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Sell Order Date: Saturday, 28 November, 2020</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">E-mail Address: vendastruefarmers@gmail.com</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Products</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">--------------------------------------------------------------</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><strong><span style="font-family: 宋体;color: rgb(255, 0, 0);letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><span style="font-family:宋体">${product}</span></span></strong><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">--------------------------------------------------------------</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Total: </span><strong><span style="font-family: 宋体;color: rgb(255, 0, 0);letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><span style="font-family:宋体">US$${price}</span></span></strong><strong><span style="font-family: Verdana;color: rgb(255, 0, 0);letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span></strong><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Status: New Order</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><strong><span style="text-decoration:underline;"><span style="font-family: Verdana;color: rgb(30, 84, 148);letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Order Flow</span></span></strong><strong><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"> : [New Order] --&gt; [Preparing] --&gt; [Delivering] --&gt; [Delivered] --&gt; [Completed] or [Canceled]</span></strong><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="text-decoration:underline;"><span style="font-family: Verdana;color: rgb(30, 84, 148);letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">Read more</span></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"> about selling at </span><span style="font-family: 宋体;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">P2PAH</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"> and </span><span style="text-decoration:underline;"><span style="font-family: Verdana;color: rgb(30, 84, 148);letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">payment request schedule and fee.</span></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)"><br></span><span style="font-family: 宋体;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">P2PAH</span><span style="font-family: Verdana;letter-spacing: 0;font-size: 14px;background: rgb(255, 255, 255)">.com Team</span></p>
  `
}